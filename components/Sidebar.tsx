                ...
                <p className='text-gray-500'>
                    ...
                    <div className='pr-4'>
                        <GoogleLogin 
                           ...
                           render={(renderProps) => (
                            <button
                               className='cursor pointer bg-white text-lg text-[#F51997] border-[1px] border-[#F51997] font-semibold px-6 py-3 rounded-md outline-none w-full mt-3 hover:text-white hover:bg-[#F52997]'
